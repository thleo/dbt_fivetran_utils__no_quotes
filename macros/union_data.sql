...
{{ adapter.dispatch('union_data', macro_namespace = fivetran_utils__no_quotes._get_utils_namespaces()) (table_identifier, database_variable, schema_variable, default_database, default_schema, default_variable) }}
